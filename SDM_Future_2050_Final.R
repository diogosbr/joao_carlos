...
cl <- parallel::makeCluster(40, type = "MPI", outfile = "./joao.log")
...
foreach(
  ...
  try({
    ...
    writeRaster(
      ...
      filename = paste0(
        ...
        especie,
        "_",
        "Current Climate_GBM Binary.tif"
      ),
      formato = "GTiff",
      overwrite = TRUE
    )
  ...
  try({
    ...
    writeRaster(
      ...
      filename = paste0(
        ...
        especie,
        "_",
        "Current Climate_CTA Binary.tif"
      ),
      formato = "GTiff",
      overwrite = TRUE
    )
  ...
  try({
    ...
    writeRaster(
      ...
      filename = paste0(
        ...
        especie,
        "_",
        "Current Climate_GLM Binary.tif"
      ),
      formato = "GTiff",
      overwrite = TRUE
    )
  ...
  try({
    ...
    writeRaster(
      ...
      filename = paste0(
        ...
        especie,
        "_",
        "Current Climate_GAM Binary.tif"
      ),
      formato = "GTiff",
      overwrite = TRUE
    )
  ...
  try({
    ...
    writeRaster(
      ...
      filename = paste0(
        ...
        especie,
        "_",
        "Current Climate_ANN Binary.tif"
      ),
      formato = "GTiff",
      overwrite = TRUE
    )
  ...
  try({
    ...
    writeRaster(
      ...
      filename = paste0(
        ...
        especie,
        "_",
        "Current Climate_MARS Binary.tif"
      ),
      formato = "GTiff",
      overwrite = TRUE
    )
  ...
  try({
    ...
    writeRaster(
      ...
      filename = paste0(
        ...
        especie,
        "_",
        "Current Climate_FDA Binary.tif"
      ),
      formato = "GTiff",
      overwrite = TRUE
    )
  ...
  projections.binary.all <-
    BinaryTransformation(projections.all.mean, th_mean)
  writeRaster(
    projections.binary.all,
    filename = paste0(
      "./outputs/",
      especie,
      "_",
      "Ensemble Binary - Current Climate.tif"
    ),
    format = "GTiff",
    overwrite = TRUE
  )
  ...
  try({
    ...
    writeRaster(
      ...
      filename = paste0(
        ...
        especie,
        "_",
        "Future Climate_MAXENT.Phillips.tif"
      ),
      formato = "GTiff",
      overwrite = TRUE
    )
  ...
  #--------------------------------------------#
  try({
    projections.binary.future.RF <-
      BinaryTransformation(projections.RF.mean.2050.rcp85, th_RF) #Calcular th
  ...
  try({
    projections.binary.future.GBM <-
      BinaryTransformation(projections.GBM.mean.2050.rcp85, th_GBM) #Calcular th
  ...
  try({
    projections.binary.future.CTA <-
      BinaryTransformation(projections.CTA.mean.2050.rcp85, th_CTA) #Calcular th
  ...
  try({
    projections.binary.future.GLM <-
      BinaryTransformation(projections.GLM.mean.2050.rcp85, th_GLM) #Calcular th
  ...
  try({
    projections.binary.future.GAM <-
      BinaryTransformation(projections.GAM.mean.2050.rcp85, th_GAM) #Calcular th
  ...
  try({
    projections.binary.future.ANN <-
      BinaryTransformation(projections.ANN.mean.2050.rcp85, th_ANN) #Calcular th
  ...
  try({
    projections.binary.future.MARS <-
      BinaryTransformation(projections.MARS.mean.2050.rcp85, th_MARS) #Calcular th
    ...
    writeRaster(
      ...
      filename = paste0(
        ...
        especie,
        "_",
        "Future Climate_MARS Binary.tif"
      ),
      formato = "GTiff",
      overwrite = TRUE
    )
  ...
  try({
    projections.binary.future.FDA <-
      BinaryTransformation(projections.FDA.mean.2050.rcp85, th_FDA) #Calcular th
  ...
  try({
    projections.binary.future.MAXENT.Phillips <-
      BinaryTransformation(projections.MAXENT.Phillips.mean.2050.rcp85,
    ...
    writeRaster(
      ...
      filename = paste0(
        ...
        especie,
        "_",
        "Future Climate_MAXENT.Phillips Binary.tif"
      ),
      formato = "GTiff",
      overwrite = TRUE
    )
